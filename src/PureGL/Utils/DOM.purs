...
import PureGL.WebGL.Types (WEBGL, WebGL2Context, WebGLContext)
...
getWebGL2Context :: forall eff. HTMLCanvasElement -> Eff (webgl :: WEBGL | eff) (Maybe WebGL2Context)
...
foreign import _getWebGL2Context :: forall eff. HTMLCanvasElement -> Eff (webgl :: WEBGL | eff) (Nullable WebGL2Context)
